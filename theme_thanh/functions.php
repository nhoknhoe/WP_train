...
function stheme_add_boostrap() {
  wp_register_style('bootstrap-style', get_template_directory_uri() . '/vendor/bootstrap/css/bootstrap.min.css');
  ...
  wp_register_script('jqBootstrapValidation', get_template_directory_uri() . '/js/jqBootstrapValidation.js', array(), false, true);
  wp_enqueue_script('jqBootstrapValidation');
  wp_register_script('contact_me', get_template_directory_uri() . '/js/contact_me.js', array(), false, true);
  wp_enqueue_script('contact_me');
  wp_register_script('clean-blog', get_template_directory_uri() . '/js/clean-blog.min.js', array(), false, true);
